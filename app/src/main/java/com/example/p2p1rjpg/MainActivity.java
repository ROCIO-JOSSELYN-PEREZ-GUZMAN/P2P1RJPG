...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visc = (RadioButton) findViewById(R.id.rblsc);
        vitics = (RadioButton) findViewById(R.id.rblTC);
        vambiental = (RadioButton) findViewById(R.id.brlamb);
        vgastro = (RadioButton) findViewById(R.id.rblG);
    ...
    public void seleccion (View view){
        ...
        if(vitics.isChecked()) Toast.makeText(this, "Ingenieria en Tecnologia ", Toast.LENGTH_SHORT).show();
        ...
        if(trabajo.isChecked()) Toast.makeText(this, "Ocupas internet en el Trabajo", Toast.LENGTH_SHORT).show();
